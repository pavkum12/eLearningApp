...
export const addQuestionAction = (questionContent) => async (dispatch) => {
  try {
    return AuthService.addQuestionFunction(questionContent)
      .then((data) => {
        dispatch({
...
export const getCourseAction = () => async (dispatch) => {
  try {
    return AuthService.getCourseFunction()
      .then((data) => {
        dispatch({
...
export const getQuestionAction = () => async (dispatch) => {
  try {
    return AuthService.getQuestionFunction()
      .then((data) => {
        dispatch({
          type: actionType.GETQUESTION,
          payload: { data },
        });
        return Promise.resolve(data);
      })
...
export const getUpdateAction = () => async (dispatch) => {
  try {
    return AuthService.getUpdateFunction()
      .then((data) => {
        dispatch({
...
export const addAdminAction = (NewAdminContent) => async (dispatch) => {
  try {
    return AuthService.addAdminFunction(NewAdminContent)
      .then((data) => {
        dispatch({
          type: actionType.ADDADMIN,
          payload: { data },
        });
        return Promise.resolve(data);
      })
      .catch((error) => {
        ...
        dispatch({
          payload: { err: error.message || "New Admin can't be added" },
        });
        return Promise.reject(error);
      });
  } catch (err) {
